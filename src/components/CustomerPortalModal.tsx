        ...
        <div className="bg-[#5C0F1E] text-white p-5 flex items-center justify-between border-b border-[#780016]">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <h2 className="font-display text-[22px] tracking-wider leading-none text-white">
          ...
          {!isLoggedIn ? (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="p-3 bg-[#FDF6E2] rounded-xs border border-[#C9A227]/40 text-[11px] text-[#735A00]">
                <strong>Corridor Shipper Access:</strong> Manage manifests, download commercial invoice templates, and view customs clearance status.
              </div>
            ...
            <div className="text-center py-4 space-y-4">
              ...
              <div>
                ...
                <p className="text-[12px] text-[#666666]">Account #OMI-CORP-9921 • Tier 1 Approved</p>
              </div>
              ...
              <div className="bg-[#FAF7F2] p-4 rounded-xs border border-[#EAE4D8] text-left text-[12px] space-y-2">
                ...
                <div className="flex justify-between font-medium">
                  <span>Next Guaranteed Departure:</span>
                  <span className="font-bold text-[#15110F]">Flight OM-814 (Tomorrow)</span>
                </div>
                <div className="flex justify-between font-medium">
              ...
              <button
                onClick={onClose}
                className="w-full py-2.5 bg-[#5C0F1E] text-white font-bold text-[12px] tracking-wider uppercase rounded-xs cursor-pointer"
              >
                Return to Dashboard
              </button>
            </div>
